...
class HomeActivityViewModel : ViewModel() {
    ...
    fun updateAirQualityData(daily:List<AQDailyAirQuality>){
        ...
        _chartModelUpdateSeriesArray.postValue(arrayOf(
            ...
            AASeriesElement()
                ...
                .color(gradientColorDic1)
                .yAxis(0)
                .data(arrayOf(daily[0].pm10.toFloat(), daily[1].pm10.toFloat(), daily[2].pm10.toFloat(), daily[3].pm10.toFloat(), daily[4].pm10.toFloat())),
            AASeriesElement()
                .name("空气质量指数")
                .type(AAChartType.Line)
                .marker(
    ...
    fun searchPlaces(location:String){
        ...
        Log.i("HomeActivityViewModel","当前查询的location是$location")
    }
